            ...
            <table class="table table-index w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.faqCategory.fields.category') }} (AR)
                        </th>
                        <th>
                            {{ trans('cruds.faqCategory.fields.category') }} (EN)
                        </th>
                        <th>
                        </th>
                    </tr>
                ...
                <tbody>
                    @forelse($faqCategories as $faqCategory)
                        <tr>
                            ...
                            <td>
                                {{ $faqCategory->translate('ar')->category }}
                            </td>
                            <td>
                                {{ $faqCategory->translate('en')->category }}
                            </td>
                            <td>
