    ...
    <div class="localesTranslateContent pt-4">
        <div id="arabic-inputs" class="tabsChild block">
            <div class="form-group {{ $errors->has('trainingCategory.name_ar') ? 'invalid' : '' }}">
                ...
                <input class="form-control" type="text" name="name_ar" id="name_ar"  wire:model.defer="trainingCategory.name_ar">
            ...
            <div class="form-group {{ $errors->has('trainingCategory.meta_description_ar') ? 'invalid' : '' }}">
                ...
                <textarea class="form-control" type="text" name="meta_description_ar" id="meta_description_ar"  wire:model.defer="trainingCategory.meta_description_ar"></textarea>
                <div class="validation-message">
        ...
        <div id="english-inputs" class="tabsChild hidden">
            <div class="form-group {{ $errors->has('trainingCategory.name_en') ? 'invalid' : '' }}">
                ...
                <input class="form-control" type="text" name="name_en" id="name_en"  wire:model.defer="trainingCategory.name_en">
                <div class="validation-message">
            ...
            <div class="form-group {{ $errors->has('trainingCategory.meta_description_en') ? 'invalid' : '' }}">
                ...
                <textarea class="form-control" type="text" name="meta_description_en" id="meta_description_en"  wire:model.defer="trainingCategory.meta_description_en"></textarea>
                <div class="validation-message">
